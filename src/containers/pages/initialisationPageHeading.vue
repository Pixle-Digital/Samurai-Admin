<template>
  <b-row>
    <b-colxx xxs="12">
      ...
      <initialisation-modal></initialisation-modal>
      <piaf-breadcrumb />
      <div class="mb-2 mt-2">
        <b-button
          variant="empty"
...
import initialisationModal from "./InitialisationModal";

export default {
  name: "initialisationPageHeading",
  components: {
    "data-list-icon": DataListIcon,
    "thumb-list-icon": ThumbListIcon,
    "image-list-icon": ImageListIcon,
    "initialisation-modal": initialisationModal
  },
  props: [
    "title",
    "selectAll",
